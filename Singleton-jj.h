...
#include <cassert>
#include <cstdlib>
#include <stdexcept>  // for std::logic_error. jjhou add.
#include <new>
#include <algorithm>  // upper_bound, copy_backward
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // 以下是 jjhou 把 SingletonWithLongevity::Adapter 搬出來的結果。
    template <class T>
    struct Adapter
    {
    ...
    public:
        ...
        {
        /*  G32 說 local class 不行。所以 jjhou 把它搬到外頭	
            struct Adapter
            {
                void operator()(T*) { return pFun_(); }
                void (*pFun_)();
...
////////////////////////////////////////////////////////////////////////////////
    ...
    private:
        ...
        // Data
        //typedef ThreadingModel<T>::VolatileType InstanceType; // remark by jjhou
        typedef T InstanceType;	// add by jjhou, 適用於單緒模型（p151）
...
////////////////////////////////////////////////////////////////////////////////
    ...
    <
        ...
        template <class> class M
    >
    bool SingletonHolder<T, C, L, M>::destroyed_; // 侯捷：為什麼不設為 false？
